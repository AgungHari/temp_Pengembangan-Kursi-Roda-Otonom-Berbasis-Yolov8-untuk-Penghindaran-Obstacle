...
def draw_grid(img, detection_status, camera_position):
    ...
    for pos in camera_position:
        x, y = pos
        # Koreksi koordinat yang diberikan agar sesuai dengan ekspektasi tanpa penambahan atau pengurangan
        x = x - 1  # Mengurangi 1 dari nilai x karena indeks dihitung dari 0
        y = y - 1  # Mengurangi 1 dari nilai y karena indeks dihitung dari 0
                ...
                if cls == 0:  # Memeriksa apakah objek terdeteksi adalah 'person'
                    ...
                    if pose_results.pose_landmarks:
                        ...
                        if jarak_pix > 0:
                            ...
                            grid_x = int((1 - posisi_horizontal_piksel / lebar_img) * 10)
                            grid_y = max(0, min(9, int(jarak_mediapipe / 0.2)))
                    ...
                    cv2.putText(img, f"{direction} {distance:.2f}m", (10, 240), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
