...
k = 23.479 #120     Diperoleh dari kalibrasi, menyesuaikan sesuai kebutuhan
k2 = 24.222
                    ...
                    if cls == 0:  # Memeriksa apakah objek terdeteksi adalah 'person'
                        ...
                        if pose_results.pose_landmarks:
                            ...
                            if jarak_pix > 0:
                                ...
                                grid_x = int(((x1 + 250) / lebar_img) * 10)
                                pusar = pose_results.pose_landmarks.landmark[mp_pose.PoseLandmark.NOSE]
                        ...
                        if pesan != newtex:
                            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                                ...
                                writer.writerow({"Direction": pesan, "Distance": distance, "Timestamp": date.strftime("%Y-%m-%d %H:%M:%S.%f")[:-3]})
